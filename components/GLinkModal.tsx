			...
			<View  className='flex-1 px- bg-[#00000056] px-5 relative justify-center'>
				<View className=' px-6 pt-5 pb-6 rounded-2xl  bg-white '>
					...
					<Text
						...
						Copy this link and send it to the people from
						whom you want to receive payment. Also, don't
						forget to save it in case you want to use it
						later
					</Text>
					<View className='mt-3'>
                    ...
                    <View className='mt-3'>
						...
						<View className='flex-row border border-[#DADADA] bg-white p-4 rounded-xl justify-between'>
							...
							<TouchableOpacity onPress={() => copyToClipboard(textToLink)}>
								<Image
									source={icons.link}
									className='h-5 w-5'
								/>
					...
					<TouchableOpacity  onPress={() => setPaymentModal(!true)} className='border-2 mt-3 items-center justify-center bg-[#6E3EFF] rounded-full w-full border-white'>
